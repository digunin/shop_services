...
ALTER TABLE IF EXISTS public.log_action
    OWNER to postgres;
...
(
    ...
    CONSTRAINT action_id_fk FOREIGN KEY (action_id)
        REFERENCES public.log_action (action_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
(
    ...
    CONSTRAINT product_plu UNIQUE (product_plu)
)
